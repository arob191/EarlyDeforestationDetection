...
def process_tile_pair(group, output_dir, target_crs="EPSG:4326", 
    ...
    # Retrieve the distance map path from time_period1 (or choose time_period2 as desired)
    distance_map_path = row1.iloc[0].get('distance_path', '')
...
def main():
    # Input combined CSV with forest filepaths.
    ...
    # Further processing (like mosaicking tiles) can be added here if desired.
